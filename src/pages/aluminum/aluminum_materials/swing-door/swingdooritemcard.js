        ...
        <>
            <div className="glass-cards" onClick={()=> changecontent(props)}>
                <div className="image-box">
                    <img src={require('../../../../images/aluminum_type/swing-door/' + props.img + '.jpg')} alt="Image" />
                </div>
                                ...
                                return(
                                    <div>
                                        <div className='left-popup'>
                                            <img className='popup-image' src={require('../../../../images/aluminum_type/swing-door/' + pop.img + '.jpg')} alt="" />
