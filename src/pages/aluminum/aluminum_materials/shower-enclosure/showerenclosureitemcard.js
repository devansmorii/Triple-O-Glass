        ...
        <>
            <div className="glass-cards" onClick={()=> changecontent(props)}>
                <div className="image-box">
                    <img src={require('../../../../images/aluminum_type/shower-enclosure/' + props.img + '.jpg')} alt="Image" />
                </div>
                                ...
                                return(
                                    <div>
                                        <div className='left-popup'>
                                            <img className='popup-image' src={require('../../../../images/aluminum_type/shower-enclosure/' + pop.img + '.jpg')} alt="" />
